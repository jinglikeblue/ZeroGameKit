...
namespace Sokoban
{
    class SokobanGameStage : AView
    {
        ...
        {
            var prefab = ResMgr.Load<GameObject>(R.Target_prefab);
        ...
        {
            var prefab = ResMgr.Load<GameObject>(R.game_Block_prefab);
        ...
        {
            var prefab = ResMgr.Load<GameObject>(R.Box_prefab);
        ...
        {
            var prefab = ResMgr.Load<GameObject>(R.Role_prefab);
