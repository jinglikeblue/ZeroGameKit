...
namespace Sokoban
{
    class SokobanGameStage : AView
    {
        ...
        {
            var prefab = Assets.Load<GameObject>(R.Target_prefab);
        ...
        {
            var prefab = Assets.Load<GameObject>(R.game_Block_prefab);
        ...
        {
            var prefab = Assets.Load<GameObject>(R.Box_prefab);
        ...
        {
            var prefab = Assets.Load<GameObject>(R.Role_prefab);
