...
{
    unsafe class Zero_ASingleton_1_ConfigMgr_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Zero.ASingleton<Zero.ConfigMgr>);
            args = new Type[]{};
        ...
        static StackObject* get_Ins_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Zero.ASingleton<Zero.ConfigMgr>.Ins;
