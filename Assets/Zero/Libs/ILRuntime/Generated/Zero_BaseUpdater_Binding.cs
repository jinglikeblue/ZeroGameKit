...
{
    unsafe class Zero_BaseUpdater_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Zero.BaseUpdater);
            args = new Type[]{};
        ...
        static StackObject* Start_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Zero.BaseUpdater instance_of_this_method = (Zero.BaseUpdater)typeof(Zero.BaseUpdater).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
