...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Zero_ILBridge_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Zero.ILBridge);
            ...
            args = new Type[]{typeof(System.Object), typeof(System.Collections.IEnumerator)};
        ...
        static StackObject* StopAllCoroutines_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Zero.ILBridge instance_of_this_method = (Zero.ILBridge)typeof(Zero.ILBridge).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.StopAllCoroutines(@target);
        ...
        static StackObject* StartCoroutine_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.StartCoroutine(@target, @coroutine);
