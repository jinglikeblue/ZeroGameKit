...
{
    unsafe class One_IChannel_Binding
    {
        ...
        static StackObject* Send_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            One.IChannel instance_of_this_method = (One.IChannel)typeof(One.IChannel).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
