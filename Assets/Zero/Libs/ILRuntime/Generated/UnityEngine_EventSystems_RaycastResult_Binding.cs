...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_RaycastResult_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRFieldGetter(field, get_worldPosition_0);
            app.RegisterCLRFieldSetter(field, set_worldPosition_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_worldPosition_0, AssignFromStack_worldPosition_0);
        ...
        static object get_worldPosition_0(ref object o)
        {
            return ((UnityEngine.EventSystems.RaycastResult)o).worldPosition;
        }

        static StackObject* CopyToStack_worldPosition_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((UnityEngine.EventSystems.RaycastResult)o).worldPosition;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_worldPosition_0(ref object o, object v)
        {
        ...
        static StackObject* AssignFromStack_worldPosition_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
